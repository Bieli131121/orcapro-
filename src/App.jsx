...
const seedData = u0 => ({
  budgets:[
    {id:uid(),num:"ORC-001",userId:u0,clientName:"João Silva",clientId:"c1",phone:"11991230001",
     ...
     paymentMethod:"PIX",warrantyDays:90,urgent:false,rating:null},
    {id:uid(),num:"ORC-002",userId:u0,clientName:"Maria Costa",clientId:"c2",phone:"21991230002",
     ...
     paymentMethod:"A combinar",warrantyDays:30,urgent:false,rating:null},
  ],
  clients:[
...
function App({user,data,patch,themeP,themeA,onLogout}){
  ...
  const saveBudget=f=>{
    ...
    else{const n={...f,id:uid(),num:nextNum,userId:user.id,total,createdAt:today()};setBudgets(bs=>[n,...bs]);setOrcCounter(c=>(c||1)+1);addAct(`Criou ${nextNum}`);}
